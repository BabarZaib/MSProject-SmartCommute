from .views import dashboard, admin_registration, employee_registration, index, signin_view, logout_view, all_employees, \
    ...
    implement_algorithm, map_employees_to_vehicle, change_request_list_admin
...
urlpatterns = [
    ...
    path('map_employees_to_vehicle/', map_employees_to_vehicle, name='map_employees_to_vehicle'),
    path('change_request_list_admin/', change_request_list_admin, name='change_request_list_admin'),
